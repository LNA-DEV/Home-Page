...
So let's start with the retrieval of the RSS data. To simplify this for me, I used the `feedparser` library here. With that, I have access to all the data of the RSS feed in a better-structured way.
