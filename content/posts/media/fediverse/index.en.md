...
This is extremely important when it comes to messengers. Not using the specific service that is popular in your region can have a significant impact. Personally, I stopped using WhatsApp for around a year. In Germany, where I'm from, it is used nearly without exception. A few people have [Signal](https://www.signal.org/) or [Threema](https://threema.ch/en), but that's about it. Not having WhatsApp did affect my day-to-day life significantly. While I thought that using other services might encourage a few people to switch, it did only to some extent. Not everyone made the transition and some friends or family members remained exclusively on WhatsApp. Beyond the challenge of communicating with those you know, like and love, there are difficulties in meeting new people. I've had experiences where some form negative opinions if you don't use the service that is common. Moreover, the barrier of contacting someone is much higher if they need to install a new app and you cannot contact them because you don't have the right messanger.
...
There's also a good amount of instances for LGBTQ+ to create safe spaces for those people. I consistently see [different instances](https://www.fediverse.to/search/?category=lgbt) with this objective.
...
Mastodon is the biggest and also the most developed platform of the Fediverse. It is a microblogging service. The company behind it is a German non-profit company (gGmbH). It is comparable with Twitter and gained a lot of attraction during [the catastrophic takeover of Elon Musk](https://www.theguardian.com/technology/2023/oct/27/elon-musk-x-twitter-takeover-revenue-users-advertising). At that time, there was a huge mass of people moving to Mastodon from Twitter.

After these events, the "freed" platform attracted [even more extreme right-wing individuals](https://www.theguardian.com/world/2023/jun/03/twitter-conservative-media-elon-musk-ron-desantis). Additionally, many [journalists face occasional blocks](https://www.theguardian.com/technology/2022/dec/16/twitter-elon-musk-suspension-journalists-sets-dangerous-precedent-un-warns). If you truly seek a free platform, consider joining Mastodon: [https://joinmastodon.org](https://joinmastodon.org).
...
Instagram is a really big platform run by Meta, which is known for its [extremely bad privacy](https://tuta.com/blog/posts/google-facebook-free) and they also had a few scandals. For example, they helped manipulate elections. See [Cambridge Analytica](https://www.theguardian.com/news/2018/mar/17/cambridge-analytica-facebook-influence-us-election).
...
Currently, Threads is implementing the required  [ActivityPub](../../../tags/activitypub) logic to join the network. You can already follow the CEO of Instagram and a few of the team. But it seems like the full connection will take a while to implement.
